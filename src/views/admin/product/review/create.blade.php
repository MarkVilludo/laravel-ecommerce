        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title"></i>Add Product Review</h4>
       ...
       <template>
            ...
            <div class='col-lg-6 col-lg-offset-6'>
                ...
                <div class="form-group text-right" style="padding-top: 20px">
                    <button class="btn btn-success waves-effect waves-light btn-block" type="buttom" @click="onSaveProductReview()">
                                    Save
                    </button>
                </div>
            </div>
...
<script>
    ...
    var vue = new Vue({
        ...
        methods: {
            onSaveProductReview() {
                axios.post("{{route('api.product_review.save', $product->id)}}", {
                    rate: this.rate,
                    title: this.title,
