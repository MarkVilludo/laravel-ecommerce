...
<div class="content">
      ...
      <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Return Policy</h4>
    ...
    <template>
        ...
        <button class="btn btn-success btn-block pt-2 pb-2" @click="updateReturnPolicy()"> Update </button>
    </template>
...
<script>
    ...
    methods: {
        getTermsCondition(url) {
            ...
            axios.post("{{route('pages.update_return-policy',1)}}", { 
    ...
    computed: {
        ...
        mounted() {
            this.getTermsCondition("{{route('api.return_policy')}}");
        }
    })
</script>
@endsection
