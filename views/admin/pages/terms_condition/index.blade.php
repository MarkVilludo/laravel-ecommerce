...
<div class="content">
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb float-right">
                    <li class="breadcrumb-item"><a href="{{route('journals.index')}}">Terms and Conditions</a></li>
    ...
    <template>
        ...
        <button class="btn btn-success btn-block pt-2 pb-2" @click="updateTermsCondition()"> Update </button>
    </template>
...
<script>
    ...
    methods: {
        getTermsCondition(url) {
            ...
            axios.post("{{route('pages.update_terms-condition',1)}}", { 
    ...
    computed: {
        ...
        mounted() {
            this.getTermsCondition("{{route('api.terms_condition')}}");
        }
    })
</script>
@endsection
