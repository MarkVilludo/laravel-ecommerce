            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <h4 class="page-title"></i>Edit Banner</h4>
                ...
                <div class='col-lg-6 col-lg-offset-6'>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            @if($banner->file_name) 
                                <label>Image</label>
                                <img src="{{url($banner->path.'/'.$banner->file_name)}}" class="rounded-square img-thumbnail">
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title"  value="{{$banner->title}}" parsley-trigger="change" required="required" placeholder="Name" class="form-control" id="name">
                    </div>
                    <div class="form-group">
                        <label for="name">Description</label>
                        <textarea id="description" name="description"  placeholder="Description" class="form-control" style="margin-top: 0px; margin-bottom: 0px; height: 200px;">{{$banner->description}}</textarea>
                    </div>
                    <input type="button" @click="updateBanner()" class="btn btn-info" value="Submit">
                </div>
            </template>
...
<script>
    ...
    methods: {
        updateBanner() {
            axios.post("{{route('api.banners.update', $banner->id)}}", { 
