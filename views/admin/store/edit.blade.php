        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title"></i>Edit Store</h4>
        ...
        <template>
            ...
            <div class='col-lg-6 col-lg-offset-6'>
                ...
                <div class="form-group">
                    ...
                    <textarea v-model="complete_address" name="complete_address" parsley-trigger="change" required="required" placeholder="Complete Address" class="form-control" id="complete_address" style="margin-top: 0px; margin-bottom: 0px; height: 212px;"> </textarea>
                </div>

                <div class="form-group text-right" style="padding-top: 20px">
                    <button class="btn btn-success waves-effect waves-light btn-block" type="buttom" @click="onUpdateStores()">
                                    Update
                    </button>
                </div>
            </div>
...
<script>
    ...
    var vue = new Vue({
        ...
        methods: {
            getStoreDetails() {
                axios.get("{{route('api.stores.details', $storeId)}}", {
                    headers: {
                ...
                .then((response) => {
                  ...
                  this.complete_address = response.data.store.complete_address;
            ...
            onUpdateStores() {
                axios.post("{{route('api.stores.update', $storeId)}}", {
                    name: this.name,
